...
static const u1_t PROGMEM APPKEY[16] = { 0xE0, 0x30, 0xF0, 0xDB, 0xE9, 0x5B, 0x0C, 0x95,
...
void do_send(osjob_t* j){
    ...
    if (LMIC.opmode & OP_TXRXPEND) {
        ...
        payload[2] = 0;       // minute
        payload[3] = 1;       // second
        payload[4] = 11;      // sequence

        // latitude 55.60778 → 55607780
        payload[5] = (55607780 >> 24) & 0xFF;
        payload[6] = (55607780 >> 16) & 0xFF;
        payload[7] = (55607780 >> 8) & 0xFF;
        payload[8] = 55607780 & 0xFF;

        // longitude 12.99639 → 12996390
        payload[9]  = (12996390 >> 24) & 0xFF;
        payload[10] = (12996390 >> 16) & 0xFF;
        payload[11] = (12996390 >> 8) & 0xFF;
        payload[12] = 12996390 & 0xFF;

        payload[13] = 1;      // label: traffic_transport
